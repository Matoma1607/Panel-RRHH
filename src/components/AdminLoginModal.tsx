  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl border border-slate-100 overflow-hidden relative">
        ...
        {/* Header */}
        <div className="bg-[#232f32] text-white p-6 relative">
          <button
            onClick={onClose}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-black tracking-tight">Acceso Gestión RRHH</h3>
              <p className="text-xs text-slate-300">Solo administradores y encargados</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-teal-600 focus:bg-white transition-all"
                autoFocus
              />
            </div>
            {errorMsg && (
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 py-3.5 px-4 bg-teal-700 hover:bg-teal-800 text-white rounded-2xl font-bold text-sm shadow-md shadow-teal-700/20 transition-all cursor-pointer"
          >
